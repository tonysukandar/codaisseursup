...
indoors = Category.create!(name: "Indoors")
outdoors = Category.create!(name: "Outdoors")
enjoy = Category.create!(name: "Enjoy")

event_1 = Event.create!(name: "Comic con", description: "Comics convention", location: "Amsterdam Rai", price: 12.00, capacity: 5000, includes_food: false, includes_drinks: false, active: true, image_link: "http://www.filmdomein.nl/wp-content/uploads/2016/07/ACC_artikel_01.jpg", user: tony, categories: [fun, indoors])
event_2 = Event.create!(name: "Amsterdam Fringe Festival", description: "Festival", location: "Amsterdam", price: 35.00, capacity: 7500, includes_food: true, includes_drinks: false, active: true, image_link: "http://www.annemariehagenaars.nl/wp-content/uploads/2012/06/fringe-url-logo-2011_web.jpg", user: tony, categories: [fun, outdoors, enjoy])
